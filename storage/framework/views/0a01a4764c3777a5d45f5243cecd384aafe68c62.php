            ...
            <?php endif; ?>
              ...
              <td>
                <?php if($p->estado != "consulta" && $p->estado!= "alta" && $p->estado !="Internado" && $p->estado != "Operado" && $p->estado != "Operar"): ?>
                    ...
                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal<?php echo e($p->id); ?>" id="button1">
                      Asignar sala
                    </button>
              ...
              <td>
                <?php if($p->operar == 1 || $p->estado == "Operar" ): ?>
                    ...
                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal<?php echo e($p->id); ?>" id="button1">
                      Asignar quirofano
                    </button>
...
<?php echo $__env->make("layouts.plantillaTest", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\master\resources\views/turnos/mostrar.blade.php ENDPATH**/ ?>