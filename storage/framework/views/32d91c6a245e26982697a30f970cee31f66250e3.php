...
<div class="card-body">
	...
	<div class="form-row">
	    ...
	    <table class="table table-bordered table-sm table-hover" id="myTable">
		  ...
		  <tbody id="tabla" >
		   	<?php $__currentLoopData = $cie; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		   		<tr>
		   			<td><?php echo e($c->codigo); ?></td>
		   			<td><?php echo e($c->descripcion); ?></td>
		   			<td>
		   			<button type="button" class="btn btn-dark btn-sm" data-toggle="modal" data-target="#editar<?php echo e($c->id); ?>">
		              Editar
		            </button>
		            <div class="modal fade" id="editar<?php echo e($c->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			              ...
			              <div class="modal-content">
			                ...
			                <div class="modal-body">
			                  <div class="row col-md-16">
								<div class="form-group">
									<form method="POST" action="/cie/<?php echo e($c->id); ?>">
										<?php echo csrf_field(); ?>
										...
										<div class="table-responsive">
											<table class="table table-bordered"  id=tablita>
												<tr>
													<td width="100"><input type="text" name="editarcod" class="form-control" placeholder="Cod" value="<?php echo e($c->codigo); ?>"></td>
													<td><input type="text" name="editardesc" class="form-control" value="<?php echo e($c->descripcion); ?>" ></td>
...
<?php echo $__env->make("layouts.plantillaTest", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\master\resources\views/cie/index.blade.php ENDPATH**/ ?>