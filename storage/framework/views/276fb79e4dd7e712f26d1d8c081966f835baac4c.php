...
unset($__errorArgs, $__bag); ?>" name="username" value="<?php echo e(old('username')); ?>" placeholder="Nombre de usuario" required autocomplete="username" autofocus>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <a href="<?php echo e(route('register')); ?>" type="submit" class="btn btn-dark"><i class="fas fa-sign-in-alt"></i>  Registrarse</a>
              </form>
...
</html><?php /**PATH /home/vagrant/code/triage/resources/views/auth/login.blade.php ENDPATH**/ ?>