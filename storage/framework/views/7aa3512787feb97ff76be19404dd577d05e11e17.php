...
<div class="card"> 
  ...
  <div class="form-group">
      <input type="hidden" name="cantidad_actual" id="cantidad_actual" value="<?php echo e($cantidad); ?>">
...
<script type="text/javascript">
  function actualizar(){
   ...
   var ruta = "<?php echo e(route('refresh')); ?>";
   var token = $("#token").val();
   $.ajax({
    ...
    url: ruta,
    dataType:'json',
    data:{cant:cant,"_token": "<?php echo e(csrf_token()); ?>"}
   }).done(function(info){
...
<?php echo $__env->make("layouts.plantillaTest", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/triage/resources/views/atencionclinica/index.blade.php ENDPATH**/ ?>