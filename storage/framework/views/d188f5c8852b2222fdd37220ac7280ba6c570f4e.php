...
<div class="row col-md-10">
	<form method='POST' action='/triagepreguntas'>
		...
		<a class="btn btn-dark btn-close ml-4" href="<?php echo e(route('pacientes.index')); ?>">Cancelar</a>
	</form>
...
<?php echo $__env->make("layouts.plantillaTest", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\master\resources\views/triagepreguntas/show.blade.php ENDPATH**/ ?>