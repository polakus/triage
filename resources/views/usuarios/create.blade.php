    ...
    <div class="card-header">Registracion de usuario </div>
        ...
        <form method="POST" action="{{ route('usuarios.store') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="username" type="text" class="form-control form-control-sm @error('username') is-invalid @enderror" value="{{ old('username') }}" name="username" required autocomplete="username" autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <select name="id_rol" id="id_rol" class="form-control form-control-sm select">
